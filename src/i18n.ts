...
const en = {
  ...
  'summary.memory': 'Saving ~{size} of memory',
  'settings.dedupe': 'Remove duplicate tabs',
  'settings.dedupeDesc':
...
const es: Dict = {
  ...
  'summary.memory': 'Ahorrando ~{size} de memoria',
  'settings.dedupe': 'Eliminar pestañas duplicadas',
  'settings.dedupeDesc':
...
const fr: Dict = {
  ...
  'summary.memory': '~{size} de mémoire économisée',
  'settings.dedupe': 'Supprimer les onglets en double',
  'settings.dedupeDesc':
...
const ko: Dict = {
  ...
  'summary.memory': '메모리 약 {size} 절약 중',
  'settings.dedupe': '중복 탭 정리',
  'settings.dedupeDesc':
...
const ja: Dict = {
  ...
  'summary.memory': 'メモリを約 {size} 節約中',
  'settings.dedupe': '重複タブを整理',
  'settings.dedupeDesc':
